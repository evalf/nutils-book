...
Nutils 9 was released on March 17, 2025.
...
newton, can be specified via the `method` argument. For a full overview of the
new API see the documentation [FIX].
...
Nutils 8 set in the transition from operating on basis functions and vector
...
created) sequence of function calls, Nutils 9 purpose generates and compiles a
monolithic Python function. The direct result of this change is a reduction in
...
- *Deprecated in v9a53:* function.integral
- *Deprecated in v9a53:* function.sample
